    ...
    public partial class initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaArts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorsBiography", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActorsBiography_Actors_ActorId",
                        column: x => x.ActorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorsBiography_ActorId",
                table: "ActorsBiography",
                column: "ActorId",
                unique: true);
